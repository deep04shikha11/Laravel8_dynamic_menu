<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-gray-500">
        ...
        <a href="{{ route('item.index') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">View Menu List</a>

        <a href="{{ route('subitem.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">View SubMenu List</a>
    </div>
